...
void update_feedback_random(int trial);
...
void simulate_AAA()
{
    for(int i=0; i<num_simulations; i++)
    {
        ...
        current_context = 1; simulate_acquisition();
        current_context = 1; simulate_extinction();
        current_context = 1; simulate_reacquisition();
        record_simulation(i);
        reset_simulation();
        shuffle_stimuli();
    }
...
{    
    for(int i=0; i<num_simulations; i++)
    {
        printf("simulating iteration - %i\n", i);
        current_context = 1; simulate_acquisition();
        current_context = 2; simulate_extinction();
        current_context = 1; simulate_reacquisition();
        record_simulation(i);
        reset_simulation();
        shuffle_stimuli();
...
void simulate_AAB()
{
    ...
    for(int i=0; i<num_simulations; i++)
    {
        ...
        current_context = 1; simulate_acquisition();
        current_context = 1; simulate_extinction();
        current_context = 2; simulate_reacquisition();
        record_simulation(i);
        reset_simulation();
        shuffle_stimuli();
    }
...
{    
    for(int i=0; i<num_simulations; i++)
    {
        ...
        current_context = 1; simulate_acquisition();
        current_context = 2; simulate_extinction();
        current_context = 3; simulate_reacquisition();
        record_simulation(i);
        reset_simulation();
        shuffle_stimuli();
    }
...
//    w_tan_msn = 1600.0;
    ...
    w_ltp_vis_msn = 0.25e-8;
    w_ltd_vis_msn_1 = 0.25e-8;
    w_ltd_vis_msn_2 = 0.0e-11;
    
    w_ltp_pf_tan = 1.5e-5;
    w_ltd_pf_tan_1 = 0.75e-5;
    w_ltd_pf_tan_2 = 0.0e-6;
...
void update_feedback_contingent(int trial)
{
    ...
    // Give feedback to both correct and incorrect responses
...
void write_data_file(int path)
{
    switch (path)
    {
        case 0:
            ...
            response_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/response.txt", "w");
            response_time_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/response_time.txt", "w");
            acc_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/acc.txt", "w");
            predicted_feedback_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/predicted_feedback.txt", "w");
            dopamine_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/dopamine.txt", "w");
            correlation_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/correlation.txt", "w");
            confidence_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/confidence.txt", "w");
            
            vis_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/vis.txt","w");
            w_vis_msn_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/w_vis_msn_A.txt","w");
            w_vis_msn_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/w_vis_msn_B.txt","w");
            w_vis_msn_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/w_vis_msn_C.txt","w");
            w_vis_msn_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/w_vis_msn_D.txt","w");
            
            w_pf_tan_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/w_pf_tan.txt", "w");
            pf_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/pf.txt","w");
            
            tan_output_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/tan_output.txt","w");
            msn_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_output_A.txt","w");
            msn_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_output_B.txt","w");
            msn_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_output_C.txt","w");
            msn_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_output_D.txt","w");
            motor_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_output_A.txt","w");
            motor_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_output_B.txt","w");
            motor_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_output_C.txt","w");
            motor_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_output_D.txt","w");
            
            tan_v_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/tan_v.txt","w");
            msn_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_v_A.txt","w");
            msn_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_v_B.txt","w");
            msn_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_v_C.txt","w");
            msn_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/msn_v_D.txt","w");
            motor_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_v_A.txt","w");
            motor_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_v_B.txt","w");
            motor_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_v_C.txt","w");
            motor_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAA/mot_v_D.txt","w");
            break;
            
        case 1:
            
            response_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/response.txt", "w");
            response_time_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/response_time.txt", "w");
            acc_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/acc.txt", "w");
            predicted_feedback_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/predicted_feedback.txt", "w");
            dopamine_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/dopamine.txt", "w");
            correlation_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/correlation.txt", "w");
            confidence_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/confidence.txt", "w");
            
            vis_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/vis.txt","w");
            w_vis_msn_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/w_vis_msn_A.txt","w");
            w_vis_msn_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/w_vis_msn_B.txt","w");
            w_vis_msn_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/w_vis_msn_C.txt","w");
            w_vis_msn_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/w_vis_msn_D.txt","w");
            
            w_pf_tan_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/w_pf_tan.txt", "w");
            pf_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/pf.txt","w");
            
            tan_output_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/tan_output.txt","w");
            msn_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_output_A.txt","w");
            msn_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_output_B.txt","w");
            msn_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_output_C.txt","w");
            msn_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_output_D.txt","w");
            motor_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_output_A.txt","w");
            motor_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_output_B.txt","w");
            motor_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_output_C.txt","w");
            motor_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_output_D.txt","w");
            
            tan_v_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/tan_v.txt","w");
            msn_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_v_A.txt","w");
            msn_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_v_B.txt","w");
            msn_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_v_C.txt","w");
            msn_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/msn_v_D.txt","w");
            motor_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_v_A.txt","w");
            motor_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_v_B.txt","w");
            motor_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_v_C.txt","w");
            motor_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABA/mot_v_D.txt","w");
            break;
            
        case 2:
            
            response_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/response.txt", "w");
            response_time_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/response_time.txt", "w");
            acc_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/acc.txt", "w");
            predicted_feedback_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/predicted_feedback.txt", "w");
            dopamine_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/dopamine.txt", "w");
            correlation_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/correlation.txt", "w");
            confidence_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/confidence.txt", "w");
            
            vis_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/vis.txt","w");
            w_vis_msn_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/w_vis_msn_A.txt","w");
            w_vis_msn_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/w_vis_msn_B.txt","w");
            w_vis_msn_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/w_vis_msn_C.txt","w");
            w_vis_msn_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/w_vis_msn_D.txt","w");
            
            w_pf_tan_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/w_pf_tan.txt", "w");
            pf_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/pf.txt","w");
            
            tan_output_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/tan_output.txt","w");
            msn_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_output_A.txt","w");
            msn_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_output_B.txt","w");
            msn_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_output_C.txt","w");
            msn_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_output_D.txt","w");
            motor_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_output_A.txt","w");
            motor_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_output_B.txt","w");
            motor_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_output_C.txt","w");
            motor_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_output_D.txt","w");
            
            tan_v_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/tan_v.txt","w");
            msn_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_v_A.txt","w");
            msn_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_v_B.txt","w");
            msn_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_v_C.txt","w");
            msn_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/msn_v_D.txt","w");
            motor_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_v_A.txt","w");
            motor_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_v_B.txt","w");
            motor_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_v_C.txt","w");
            motor_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/AAB/mot_v_D.txt","w");
            break;
            
        case 3:
            
            response_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/response.txt", "w");
            response_time_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/response_time.txt", "w");
            acc_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/acc.txt", "w");
            predicted_feedback_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/predicted_feedback.txt", "w");
            dopamine_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/dopamine.txt", "w");
            correlation_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/correlation.txt", "w");
            confidence_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/confidence.txt", "w");
            
            vis_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/vis.txt","w");
            w_vis_msn_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/w_vis_msn_A.txt","w");
            w_vis_msn_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/w_vis_msn_B.txt","w");
            w_vis_msn_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/w_vis_msn_C.txt","w");
            w_vis_msn_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/w_vis_msn_D.txt","w");
            
            w_pf_tan_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/w_pf_tan.txt", "w");
            pf_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/pf.txt","w");
            
            tan_output_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/tan_output.txt","w");
            msn_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_output_A.txt","w");
            msn_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_output_B.txt","w");
            msn_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_output_C.txt","w");
            msn_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_output_D.txt","w");
            motor_output_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_output_A.txt","w");
            motor_output_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_output_B.txt","w");
            motor_output_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_output_C.txt","w");
            motor_output_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_output_D.txt","w");
            
            tan_v_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/tan_v.txt","w");
            msn_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_v_A.txt","w");
            msn_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_v_B.txt","w");
            msn_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_v_C.txt","w");
            msn_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/msn_v_D.txt","w");
            motor_v_A_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_v_A.txt","w");
            motor_v_B_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_v_B.txt","w");
            motor_v_C_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_v_C.txt","w");
            motor_v_D_file = fopen("/Users/crossley/Documents/projects/research/renewal/renewal_spiking/output/ABC/mot_v_D.txt","w");
            break;
